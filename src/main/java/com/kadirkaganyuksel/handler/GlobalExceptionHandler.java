package com.kadirkaganyuksel.handler;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiError<Map<String, List<String>>>> handleMethodArgumentValidException(MethodArgumentNotValidException ex, WebRequest request) {
